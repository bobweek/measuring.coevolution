...
nn_t1df <- data.frame(pvals,type1s)
save(nn_t1df,file="~/Research/ecology letters/data/nn/nn_t1_sample.Rda")
load("~/Research/ecology letters/data/nn/nn_t1_sample.Rda")

nn_t1_plt <- ggplot(nn_t1df,aes(x=pvals,y=type1s))+
...
nn_t1_plt
ggsave("~/Research/ecology letters/nn_t1_sample_plt.eps",nn_t1_plt,width=5,height=2.5)
